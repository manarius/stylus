 ...
 *    `srcAbs`    If true, remove /css from the path.
...
module.exports = function(options){
  ...
  var replaceInStylusPath = options.replaceInStylusPath || false;
  replaceInStylusPath.rm = replaceInStylusPath.rm || false;
  replaceInStylusPath.add = replaceInStylusPath.add || '';

  
  var replaceInCssPath = options.replaceInCssPath || false;
  replaceInCssPath.rm = replaceInCssPath.rm || false;
  replaceInCssPath.add = replaceInCssPath.add || '';
  ...
  return function stylus(req, res, next){
    ...
    if (/\.css$/.test(path)) {
      ...
      //remove /css from the path to get "absolute" srcpathes.
      if (replaceInStylusPath.rm) stylusPath = stylusPath.replace(replaceInStylusPath.rm, replaceInStylusPath.add);
      if (replaceInCssPath.rm) cssPath = cssPath.replace(replaceInCssPath.rm, replaceInCssPath.add);

      console.log('cssPath = '+cssPath);
      console.log('stylusPath = '+stylusPath);
